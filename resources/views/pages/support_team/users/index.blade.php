...
<div class="card">
    ...
    <div class="card-body">
        <ul class="nav nav-tabs nav-tabs-highlight">
            <li class="nav-item"><a href="#new-user" class="nav-link active" data-toggle="tab">Create New Parents</a>
            </li>
            ...
            <div class="tab-pane fade show active" id="new-user">
                <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-store"
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            {{-- <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" name="emp_date" value="{{ old('emp_date') }}" type="text"
                        ...
                        <button type="submit" class="btn btn-primary" style="float: right; margin: 20px;">Submit
                ...
                <table class="table datatable-button-html5-columns">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img class="rounded-circle" style="height: 40px; width: 40px;" src="{{ $u->photo }}"
                                    alt="photo"></td>
                            <td>{{ $u->name }}</td>
                            <td>{{ $u->username }}</td>
                            <td>{{ $u->phone }}</td>
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-left">
                                            ...
                                            {{--Delete--}}
                                            <a id="{{ Qs::hash($u->id) }}" onclick="confirmDelete(this.id)" href="#"
                                                class="dropdown-item"><i class="icon-trash"></i> Delete</a>
                                            <form method="post" id="item-delete-{{ Qs::hash($u->id) }}"
                                                action="{{ route('users.destroy', Qs::hash($u->id)) }}" class="hidden">
