...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_title', 'description' => 'PIS'],
            ['type' => 'system_name', 'description' => 'PHOENIX INTERNATIONAL SCHOOL'],
            ['type' => 'term_ends', 'description' => '7/10/2018'],
            ['type' => 'term_begins', 'description' => '7/10/2018'],    
            ['type' => 'phone', 'description' => '077 272 6062'],
            ['type' => 'address', 'description' => ' No.25, Poles Road, Puttalam, Sri Lanka'],
            ['type' => 'system_email', 'description' => 'phoenixinternationalputtalam@gmail.com'],
